<x-layout>
    ...
    <x-slot:title>Editar producto - {{ $producto->nombre}}</x-slot>
    ...
    <form action="{{ route('productos.actualizar', $producto->producto_id) }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="categoria" name="categoria" class="form-control @error('categoria') is-invalid @enderror" value="{{ old('categoria', $producto->categoria) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="precio" name="precio" class="form-control @error('precio') is-invalid @enderror" value="{{ old('precio', $producto->precio) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="material" name="material" class="form-control @error('material') is-invalid @enderror" value="{{ old('material', $producto->material) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="dimensiones" name="dimensiones" class="form-control @error('dimensiones') is-invalid @enderror" value="{{ old('dimensiones', $producto->dimensiones) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="peso" name="peso" class="form-control @error('peso') is-invalid @enderror" value="{{ old('peso', $producto->peso) }}">
        ...
        <div class="mb-3">
            ...
            <input type="date" id="fecha_lanzamiento" name="fecha_lanzamiento" class="form-control @error('fecha_lanzamiento') is-invalid @enderror" value="{{ old('fecha_lanzamiento', $producto->fecha_lanzamiento) }}">
        ...
        <div class="mb-3">
            ...
            <input type="file" enctype="multipart/form-data"  id="imagen" name="imagen" class="form-control @error('imagen') is-invalid @enderror">
